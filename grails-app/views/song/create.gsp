                ...
                <g:form action="createSong" class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="name" name="name" type="text" placeholder="Your song's title" class="form-control input-md" required>
                                <span class="help-block">The title of the song you want to add</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="album" name="album" class="form-control" placeholder="etc. Unstoppable" type="form-control input-md" required>
                                <span class="help-block">The title of the song you want to add</span></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="genre" name="genre" type="text" placeholder="Your song's genre" class="form-control input-md" required>
                                <span class="help-block">Your song's genre</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label">Artist</label>
                            <div class="col-md-4">
                                <g:select id="artist" name="artist" from="${artistList.artistname}" noSelection="${['null':'Select One...']}" />
                                <span class="help-block">Choose your song's artist</span>
                            </div>
                        </div>
                        <!-- Button -->
