...
<script src="//netdna.bootstrapcdn.com/bootstrap/3.0.3/js/bootstrap.min.js"></script>
    ...
    <script>
       ...
       var table = $('#songList').DataTable( {
            "ajax": {
                "url": "${createLink(controller: 'song', action: 'songList')}",
                dataType: 'json',
                "dataSrc": "",
                select: true
           ...
           "fnRowCallback": function( nRow, aData ){
               ...
               $('td:eq(3)', nRow).html('<a class="btn btn-default btn-sm " href="details/' + id+ '">' +
                   ...
                   '<i class="glyphicon glyphicon-edit text-primary"></i>' + '</a>' + ' <a class="btn btn-default btn-sm " href="edit/' + id+ '">' +
    ...
    <nav class="navbar navbar-default" role="navigation">
        ...
        <div class=col-md-12 style="margin-top: 80px">
                ...
                <div class="pull-right" style="margin-: -20px ">
                    <g:link action="create" class="btn btn-default-btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Add Song</g:link>
                </div>
<%--
